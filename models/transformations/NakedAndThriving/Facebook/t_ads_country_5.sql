...
LEFT JOIN
    {{ source('bigquery_nt_fb', 'country_breakdown_video_p_50_watched_actions') }} p_50_watched
    ON ads.ad_id = p_50_watched.ad_id AND ads.`date` = p_50_watched.`date`
LEFT JOIN
    {{ source('bigquery_nt_fb', 'country_breakdown_video_p_75_watched_actions') }} p_75_watched
